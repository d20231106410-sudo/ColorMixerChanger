import 'package:color_mixer/color_circle.dart';
import 'package:color_mixer/color_value_changer.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ColorCircle(
        color: Color.fromRGBO(red.toInt(), green.toInt(), blue.toInt(), 1), size: 150,
        ),
        SizedBox(height:30),
        ColorValueChanger(
          label: "Red",
